...
var zh2 = {
  ...
  "refresh": "\u5237\u65B0",
  "customize": "\u81EA\u5B9A\u4E49",
  "customizing": "\u65B0\u5BC6\u7801\uFF087-127 \u4F4D\uFF0C\u6570\u5B57/\u5B57\u6BCD/\u7B26\u53F7\u5747\u53EF\uFF09\uFF1A",
  "save": "\u4FDD\u5B58",
  "cancel": "\u53D6\u6D88",
  "pinInvalid": "\u5BC6\u7801\u957F\u5EA6\u9700\u5927\u4E8E 6 \u4F4D\u4E14\u5C0F\u4E8E 128 \u4F4D\uFF08\u6570\u5B57\u3001\u5927\u5C0F\u5199\u3001\u7279\u6B8A\u7B26\u53F7\u5747\u53EF\uFF09",
...
var en2 = {
  ...
  "refresh": "Refresh",
  "customize": "Customize",
  "customizing": "New PIN (7-127 chars, any letters/digits/symbols): ",
  "save": "Save",
  "cancel": "Cancel",
  "pinInvalid": "PIN must be longer than 6 and shorter than 128 characters (digits, letters, and symbols are all allowed)",
...
function PocketSettingsTab({ rpcCall, t }) {
  ...
  const customPinRow = (which) => (0, import_react2.createElement)(
    ...
    (0, import_react2.createElement)("input", {
      style: { width: 150, margin: "0 6px", padding: "4px 8px", fontSize: 14, letterSpacing: 1, textAlign: "center", border: "1px solid var(--dsw-alias-border-l2,#d1d5db)", borderRadius: 6, outline: "none" },
      type: "password",
      maxLength: 127,
      value: customPin?.value ?? "",
      autoFocus: true,
      onChange: (e) => setCustomPin((c) => ({ ...c, value: e.target.value, err: null })),
      onKeyDown: (e) => {
